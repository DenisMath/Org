# -*- coding: cp1251 -*-
* Literature
[[file:Lex.pdf][Lex.pdf]] - презентация
[[file:My%20Documents/Downloads/compiler.pdf][flex_bison.pdf]]
http://citforum.ru/operating_systems/manpages/FLEX.1.shtml
http://kdi.algid.net/articles/flex_bison_in_visualc.php - flex, bison в Visual Studio
http://ds9a.nl/lex-yacc/cvs/lex-yacc-howto.html 
http://habrahabr.ru/post/99162/ - flex, пример калькулятора, объяснение работы(tracing), ДКА
* NAME
...
* OPTIONS
    ...
    stdinit
        if set (i.e., %option stdinit) initializes yyin and yyout to stdin and stdout, instead of the default of nil. Some existing lex programs depend on this behavior, even though it is not compliant with ANSI C, which does not require stdin and stdout to be compile-time constant. 
    yylineno
